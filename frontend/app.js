...
async function Deletion(id) {
    await fetch(`https://to-do-list-x72r.onrender.com/delete/${id}`,{method:"DELETE"});
    location.reload(); //for reloading entire page

}

async function markCompletion(id) {
    await fetch(`https://to-do-list-x72r.onrender.com/mark/${id}`,{method:"PUT"});
    location.reload(); //for reloading entire page
...
async function insert() {
    ...
    await fetch("https://to-do-list-x72r.onrender.com/insert", {
        method: "POST",
        headers: {
...
async function loadTasks() {
    const response = await fetch("https://to-do-list-x72r.onrender.com/showtasks");
...
`;
    ...
    const res=await fetch("https://to-do-list-x72r.onrender.com/showdone")
